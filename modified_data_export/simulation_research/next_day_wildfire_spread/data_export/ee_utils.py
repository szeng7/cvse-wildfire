...
class DataType(enum.Enum):
  ...
  FIRE_MODIS = 6
  POPULATION = 7
  FORECAST = 8 #ADDED for modified dataset
...
DATA_SOURCES = {
    ...
    DataType.FORECAST: 'NOAA/GFS0P25' #ADDED for modified dataset
}
...
DATA_TIME_SAMPLING = {
    ...
    DataType.FORECAST: 1 #ADDED for modified dataset
}
...
def get_detection_count(
  ...
  try:
    ...
    print("SUCCESS") #ADDED for modified dataset
  except ee.EEException as error:
    # If the number of positive pixels cannot be counted because of a server-
    # side error, return -1.
    print(error) #ADDED for modified dataset
    detection_count = -1
