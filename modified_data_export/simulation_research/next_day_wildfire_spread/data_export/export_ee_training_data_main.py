...
flags.DEFINE_string('folder', 'data_short',
...
def main(argv):
  ...
  # Cloud account login
  service_account = 'alex-42@wildfire-457520.iam.gserviceaccount.com'
  credentials = ee.ServiceAccountCredentials(service_account, 'wildfire-key.json')
  ee.Initialize(credentials, project="wildfire-457520")
